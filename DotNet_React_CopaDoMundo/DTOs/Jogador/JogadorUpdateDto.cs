...
namespace DotNet_React_CopaDoMundo.DTOs.Jogador
{
    public class JogadorUpdateDto
    {
        ...
        [Range(0, 150, ErrorMessage = "O número do jogador deve ser um valor entre 0 e 150.")]
        ...
        [Required(ErrorMessage = "O ID da seleção é obrigatório.")]
        [Range(1, int.MaxValue, ErrorMessage = "O ID da seleção deve ser maior que zero.")]
